...
\section{EDUCATION}
	...
	Applied Mathematics, M.S. \hfill {\sl Fall 2018 - Spring 2021} \\
    Computational Mathematics, B.A. \hfill {\sl Fall 2021 - Spring 2022 (expected)}\\
...
\section{EXPERIENCE} 
    ...
    \begin{itemize}
        \item Researching functional depth, developing methods for probabilistic order statistics 
        \item Analyzing RNA-seq data with non-parametric functional depth methods, running on a distributed compute cluster
        \item Developing Python library for statistical depth analysis on distributed edge devices 
    \end{itemize} \vspace*{-10pt}

    \textbf{Data Science Intern} $\mid$ \textit{Blackthorn Therapeutics | San Francisco, CA} 
    \begin{itemize}
        \item Used statistical modeling to research which features most heavily impact depression and anxiety rates across the US
        \item Unsupervised learning methods (clustering) to analyze which states are most heavily affected by rates of depression, unemployment and other factors caused by economic crisis 
    \end{itemize} \vspace*{-10pt}
...
\section{SKILLS}
    ...
    \textbf{Software}: Kubernetes, Docker, AWS S3, Ceph, Git, Bash 
\end{resume}
\end{document}
