...
\section{EXPERIENCE} 
    % \textbf{Software Engineering Intern} $\mid$ \textit{Valassis Digital | Austin, TX} \hfill {\sl Summer 2020}
    % \begin{itemize}
	...
	% \end{itemize}\vspace*{-10pt}
% 	\textbf{Sales Associate} $\mid$ \textit{Little Apple Treats | Sebastopol, CA} \hfill
% 	{\sl 2008 | Fall 2019}
% 	\begin{itemize}
% 	    \item Worked on the family farm since I was seven years old, both with plant starts, the greenhouses, and the food business
% 	    \item Managed the stall at the San Francisco Ferry Plaza Market, supervised loading and unloading the van, and provided service to customers throughout the day
% 	\end{itemize}
\section{PROJECTS}
